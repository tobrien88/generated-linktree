...
const TIERS: TierConfig[] = [
  ...
  },
  {
    ...
    personalizedCallout: "Built for high-revenue creators like Nova — 0% fees means you keep every dollar from link sales",
    sections: [
      {
        ...
        items: [
          ...
          "White-label experience — no Linktree branding",
